...
//! Render this table when Source, Medium, Campain, Term and Content


//! Render this table when Source, Medium, Campain and Term
...
function renderUtmSourceMediumTable(utmData) {
    ...
    if (Object.keys(utmData.rows).length === 0) {
        // No data to display
...
//! Render this table for Source Only
